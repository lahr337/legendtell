...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/js/createYourAccount.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./assets/js/createYourAccount.js":
/*!****************************************!*\
  !*** ./assets/js/createYourAccount.js ***!
  \****************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _styles_create_your_account_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @styles/create-your-account.scss */ "./assets/sass/create-your-account.scss");
/* harmony import */ var _styles_create_your_account_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_styles_create_your_account_scss__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _modules_seePassword__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/seePassword */ "./assets/js/modules/seePassword.js");
...
toLoginBtn.addEventListener('click', function () {
  if (!loginForm.classList.contains(activeFormCalss)) {
    ...
    disableBtn(toSignupBtn); // Form action
...
toSignupBtn.addEventListener('click', function () {
  if (!signupForm.classList.contains(activeFormCalss)) {
    ...
    disableBtn(toLoginBtn); // Form action

    loginForm.classList.remove(activeFormCalss);
    signupForm.classList.add(activeFormCalss);
  }
});
jquery__WEBPACK_IMPORTED_MODULE_3___default()('.toLogin').on('click', function () {
  if (!loginForm.classList.contains(activeFormCalss)) {
    // Button action
    activateBtn(toLoginBtn);
    disableBtn(toSignupBtn); // Form action
...
jquery__WEBPACK_IMPORTED_MODULE_3___default()('.toSignup').on('click', function () {
  if (!signupForm.classList.contains(activeFormCalss)) {
    // Button action
    activateBtn(toSignupBtn);
    disableBtn(toLoginBtn); // Form action
...
jquery__WEBPACK_IMPORTED_MODULE_3___default()('#kt_login_submit').on('click', function (e) {
  e.preventDefault();
  console.log('clicked');
  loginFormValidation.validate().then(function (status) {
    if (status == 'Valid') {
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(loginForm).trigger('submit');
    }
  });
});
...
jquery__WEBPACK_IMPORTED_MODULE_3___default()('#kt_register_submit').on('click', function (e) {
  e.preventDefault();
  console.log('clicked');
  signupFormValidation.validate().then(function (status) {
    if (status == 'Valid') {
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(signupForm).trigger('submit');
    }
  });
});
...
/***/ "./assets/js/modules/seePassword.js":
/*!******************************************!*\
  !*** ./assets/js/modules/seePassword.js ***!
  \******************************************/
/*! no exports provided */
...
var seePasswordBtn = document.getElementById('seePassword'),
    loginField = document.getElementById('loginPassword');
var seePasswordSignup = document.getElementById('seePasswordSignup'),
    passworSignupField = document.getElementById('signupPassword');
var seeConfirmPasswordSignup = document.getElementById('seeConfirmPasswordSignup'),
    confirmPassworSignupField = document.getElementById('signupConfirmPassword');
_classes_Inputs__WEBPACK_IMPORTED_MODULE_0__["default"].showHidePasswor(seePasswordBtn, loginField);
_classes_Inputs__WEBPACK_IMPORTED_MODULE_0__["default"].showHidePasswor(seePasswordSignup, passworSignupField);
_classes_Inputs__WEBPACK_IMPORTED_MODULE_0__["default"].showHidePasswor(seeConfirmPasswordSignup, confirmPassworSignupField);
...
/***/ "./assets/sass/create-your-account.scss":
/*!**********************************************!*\
  !*** ./assets/sass/create-your-account.scss ***!
  \**********************************************/
/*! no static exports found */
...
/******/ });
//# sourceMappingURL=createYourAccount.js.map