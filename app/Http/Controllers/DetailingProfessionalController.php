       ...
       // echo "<pre>"; print_r($request->all()); die;
        ...
        if($request->vehicle_type == "18-Wheeler Cab")
        {
            $vehicle_data = array(
                ...
                'wheeler_cab_left-side-78'  => "$request->wheeler_cab_left_side_78",
                'wheeler_cab_left-side-79'  => "$request->wheeler_cab_left_side_79",
                'wheeler_cab_left-side-80'  => "$request->wheeler_cab_left_side_80",
                'wheeler_cab_left-side-81'  => "$request->wheeler_cab_left_side_81",
                'wheeler_cab_left-side-82'  => "$request->wheeler_cab_left_side_82",
