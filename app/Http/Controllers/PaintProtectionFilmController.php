...
class PaintProtectionFilmController extends Controller
{
    ...
    public function savePaintProtectionFilm(Request $request)
    {
        ...
        // $paint_protection_film_check =  PaintProtectionFilm::where('car_id', $car_id)->where('user_id', auth()->user()->id)->first();
        ...
        // $serviceData = PaintProtectionFilm::where('car_id', $car_id)->where('service_id', $serviceId)->where('user_id', auth()->user()->id)->first();
        // if ($serviceData) {
        //     $paint_protection_film = $paint_protection_film->where('car_id', $car_id)->where('service_id', $serviceId)->where('user_id', auth()->user()->id)->first();
        // }
