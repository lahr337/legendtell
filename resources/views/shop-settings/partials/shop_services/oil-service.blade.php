                                 ...
                                 <div class="col-md-8 col-12">
                                    <div class="btn-group btn-group flex-row fluid-service" role="group">
                                       <div class="form-btnw-wrap upgrade-checked">
                                          <input type="checkbox" class="btn-check" name="oil_fluid_service" value="WINDSHIELD" id="checkbox1" autocomplete="off">
                                       ...
                                       <div class="form-btnw-wrap upgrade-checked">
                                          <input type="checkbox" class="btn-check" value="TRANSMISSION" name="oil_fluid_service" id="checkbox3" autocomplete="off">
                                       ...
                                       <div class="form-btnw-wrap upgrade-checked">
                                          <input type="checkbox" class="btn-check" name="oil_fluid_service" value="POWER" id="checkbox5" autocomplete="off">
                              ...
                              <div class="row d-flex align-items-center">
                                 ...
                                 <div class="col-md-8 col-12">
                                    <div class="btn-group btn-group d-flex flex-row" role="group" style="column-gap: 10px;">
                                       <div class="form-btnw-wrap upgrade-checked">
                                          <input type="radio" class="btn-check" name="oil_pan_removed" value="Yes" id="btnradio30" autocomplete="off">
                                          <label for="btnradio30">YES</label>
                                       </div>
                                       <div class="form-btnw-wrap upgrade-checked">
                                          <input type="radio" class="btn-check" name="oil_pan_removed" value="No" id="btnradio31" autocomplete="off">
                           ...
                           <div class="form-group">
                              <div class="row d-flex align-items-center">
                                 ...
                                 <div class="col-md-8 col-12">
                                    <div class="btn-group btn-group d-flex flex-row" role="group" style="column-gap: 10px;">
                                       <div class="form-btnw-wrap upgrade-checked">
                                          <input type="radio" class="btn-check" value="Yes" name="oil_pan_gaskit" id="btnradio110" autocomplete="off">
                                          <label for="btnradio110">YES</label>
                                       </div>
                                       <div class="form-btnw-wrap upgrade-checked">
                                          <input type="radio" class="btn-check" value="No" name="oil_pan_gaskit" id="btnradio111" autocomplete="off">
                           ...
                           <div class="form-group">
                              <div class="row d-flex align-items-center">
                                 ...
                                 <div class="col-md-8 col-12">
                                    <div class="btn-group btn-group d-flex flex-row" role="group" style="column-gap: 10px;">
                                       <div class="form-btnw-wrap upgrade-checked">
                                          <input type="radio" class="btn-check" name="oil_pan_nut" id="btnradio112" autocomplete="off" value="Yes">
                                          <label for="btnradio112">YES</label>
                                       </div>
                                       <div class="form-btnw-wrap upgrade-checked">
                                          <input type="radio" class="btn-check" name="oil_pan_nut" id="btnradio113" autocomplete="off" value="No">
