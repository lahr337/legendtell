                  ...
                  <div class="rim-repair grid-3 cmn-radio cmn-mx-75">
                     <div class="btn-group" role="group">
                        <div class="form-btnw-wrap">
                           <input type="radio" class="btn-check service_type" value="NEW INSTALL" name="service_type" id="rim-repair1" autocomplete="off">
                           <label for="rim-repair1">NEW INSTALL</label>
                        </div>
                        <div class="form-btnw-wrap">
                           <input type="radio" class="btn-check service_type" value="REPAIR" name="service_type" id="rim-repair2" autocomplete="off">
                           <label for="rim-repair2">REPAIR</label>
                        </div>
                        <div class="form-btnw-wrap">
                           <input type="radio" class="btn-check service_type" value="REPLACEMENT" name="service_type" id="rim-repair3" autocomplete="off">
