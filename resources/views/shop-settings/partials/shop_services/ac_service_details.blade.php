                        ...
                        <div class="col-12 col-md-8">
                           <div class="">
                              <div class="ac_service_content">
                                 ...
                                 <div class="btn-group" role="group">
                                    ...
                                    <div class="form-btnw-wrap bad-checked">
                                       <input type="radio" class="btn-check" name="condensorInput" id="condensorInput2" value="bad" autocomplete="off">
                                       <label for="condensorInput2">Bad</label>
                                    </div>
                                    <div class="form-btnw-wrap replaced-checked">
                                       <input type="radio" class="btn-check" name="condensorInput" id="condensorInput3" value="replaced" autocomplete="off">
                                       <label for="condensorInput3">Replaced</label>
                                    </div>
                                    <div class="form-btnw-wrap upgrade-checked">
                                       <input type="radio" class="btn-check" name="condensorInput" id="condensorInput4" value="Upgraded" autocomplete="off">
                              ...
                              <div class="ac_service_content">
                                 ...
                                 <div class="btn-group" role="group">
                                    <div class="form-btnw-wrap good-checked">
                                       <input type="radio" class="btn-check" name="compressorInput" id="compressorInput5" value="good" autocomplete="off">
                                       <label for="compressorInput5">Good</label>
                                    </div>
                                    <div class="form-btnw-wrap bad-checked">
                                       <input type="radio" class="btn-check" name="compressorInput" id="compressorInput6" value="bad" autocomplete="off">
                                       <label for="compressorInput6">Bad</label>
                                    </div>
                                    <div class="form-btnw-wrap replaced-checked">
                                       <input type="radio" class="btn-check" name="compressorInput" id="compressorInput7" value="replaced" autocomplete="off">
                                       <label for="compressorInput7">Replaced</label>
                                    </div>
                                    <div class="form-btnw-wrap upgrade-checked">
                                       <input type="radio" class="btn-check" name="compressorInput" id="compressorInput8" value="Upgraded" autocomplete="off">
                              ...
                              <div class="ac_service_content">
                                 ...
                                 <div class="btn-group" role="group">
                                    <div class="form-btnw-wrap good-checked">
                                       <input type="radio" class="btn-check" name="evaportorInput" id="evaportorInput9" value="good" autocomplete="off">
                                       <label for="evaportorInput9">Good</label>
                                    </div>
                                    <div class="form-btnw-wrap bad-checked">
                                       <input type="radio" class="btn-check" name="evaportorInput" value="bad" id="evaportorInput10" autocomplete="off">
                                       <label for="evaportorInput10">Bad</label>
                                    </div>
                                    <div class="form-btnw-wrap replaced-checked">
                                       <input type="radio" value="replaced" class="btn-check" name="evaportorInput" id="evaportorInput11" autocomplete="off">
                                       <label for="evaportorInput11">Replaced</label>
                                    </div>
                                    <div class="form-btnw-wrap upgrade-checked">
                                       <input type="radio" class="btn-check" name="evaportorInput" value="Upgraded" id="evaportorInput12" autocomplete="off">
                              ...
                              <div class="ac_service_content">
                                 ...
                                 <div class="btn-group" role="group">
                                    <div class="form-btnw-wrap good-checked">
                                       <input type="radio" class="btn-check" name="rdryerInput" value="good" id="rdryerInput3" autocomplete="off">
                                       <label for="rdryerInput3">Good</label>
                                    </div>
                                    <div class="form-btnw-wrap bad-checked">
                                       <input type="radio" class="btn-check" name="rdryerInput" id="rdryerInput4" autocomplete="off" value="bad">
                                       <label for="rdryerInput4">Bad</label>
                                    </div>
                                    <div class="form-btnw-wrap replaced-checked">
                                       <input type="radio" class="btn-check" name="rdryerInput" id="rdryerInput5" autocomplete="off" value="replaced">
                                       <label for="rdryerInput5">Replaced</label>
                                    </div>
                                    <div class="form-btnw-wrap upgrade-checked">
                                       <input type="radio" class="btn-check" name="rdryerInput" id="rdryerInput6" autocomplete="off" value="Upgraded">
                              ...
                              <div class="ac_service_content">
                                 ...
                                 <div class="btn-group" role="group">
                                    <div class="form-btnw-wrap good-checked">
                                       <input type="radio" class="btn-check" name="aclineInput" id="aclines17" autocomplete="off" value="good">
                                       <label for="aclines17">Good</label>
                                    </div>
                                    <div class="form-btnw-wrap bad-checked">
                                       <input type="radio" class="btn-check" name="aclineInput" id="aclines18" autocomplete="off" value="bad">
                                       <label for="aclines18">Bad</label>
                                    </div>
                                    <div class="form-btnw-wrap replaced-checked">
                                       <input type="radio" class="btn-check" name="aclineInput" id="aclines19" autocomplete="off" value="replaced">
                                       <label for="aclines19">Replaced</label>
                                    </div>
                                    <div class="form-btnw-wrap upgrade-checked">
                                       <input type="radio" class="btn-check" name="aclineInput" id="aclines20" autocomplete="off" value="Upgraded">
                              ...
                              <div class="ac_service_content">
                                 ...
                                 <div class="btn-group" role="group">
                                    <div class="form-btnw-wrap good-checked">
                                       <input type="radio" class="btn-check" name="pressureswitch" id="pressureSwitch21" autocomplete="off" value="good">
                                       <label for="pressureSwitch21">Good</label>
                                    </div>
                                    <div class="form-btnw-wrap bad-checked">
                                       <input type="radio" class="btn-check" name="pressureswitch" id="pressureSwitch22" autocomplete="off" value="bad">
                                       <label for="pressureSwitch22">Bad</label>
                                    </div>
                                    <div class="form-btnw-wrap replaced-checked">
                                       <input type="radio" class="btn-check" name="pressureswitch" id="pressureSwitch23" autocomplete="off" value="replaced">
                                       <label for="pressureSwitch23">Replaced</label>
                                    </div>
                                    <div class="form-btnw-wrap upgrade-checked">
                                       <input type="radio" class="btn-check" name="pressureswitch" id="pressureSwitch24" autocomplete="off" value="Upgraded">
                              ...
                              <div class="ac_service_content">
                                 ...
                                 <div class="btn-group" role="group">
                                    <div class="form-btnw-wrap good-checked">
                                       <input type="radio" class="btn-check" name="officeTube6" id="officeTube25" autocomplete="off" value="good">
                                       <label for="officeTube25">Good</label>
                                    </div>
                                    <div class="form-btnw-wrap bad-checked">
                                       <input type="radio" class="btn-check" name="officeTube6" id="officeTube26" autocomplete="off" value="bad">
                                       <label for="officeTube26">Bad</label>
                                    </div>
                                    <div class="form-btnw-wrap replaced-checked">
                                       <input type="radio" class="btn-check" name="officeTube6" id="officeTube27" autocomplete="off" value="replaced">
                                       <label for="officeTube27">Replaced</label>
                                    </div>
                                    <div class="form-btnw-wrap upgrade-checked">
                                       <input type="radio" class="btn-check" name="officeTube6" id="officeTube28" autocomplete="off" value="Upgraded">
                              ...
                              <div class="ac_service_content">
                                 ...
                                 <div class="btn-group" role="group">
                                    <div class="form-btnw-wrap good-checked">
                                       <input type="radio" class="btn-check" name="expansionIinput" id="expansionIinput29" autocomplete="off" value="good">
                                       <label for="expansionIinput29">Good</label>
                                    </div>
                                    <div class="form-btnw-wrap bad-checked">
                                       <input type="radio" class="btn-check" name="expansionIinput" id="expansionIinput30" autocomplete="off" value="bad">
                                       <label for="expansionIinput30">Bad</label>
                                    </div>
                                    <div class="form-btnw-wrap replaced-checked">
                                       <input type="radio" class="btn-check" name="expansionIinput" id="expansionIinput31" autocomplete="off" value="replaced">
                                       <label for="expansionIinput31">Replaced</label>
                                    </div>
                                    <div class="form-btnw-wrap upgrade-checked">
                                       <input type="radio" class="btn-check" name="expansionIinput" id="expansionIinput32" autocomplete="off" value="Upgraded">
                              ...
                              <div class="ac_service_content">
                                 ...
                                 <div class="btn-group" role="group">
                                    <div class="form-btnw-wrap good-checked">
                                       <input type="radio" class="btn-check" name="sealInput" id="sealInput33" autocomplete="off" value="good">
                                       <label for="sealInput33">Good</label>
                                    </div>
                                    <div class="form-btnw-wrap bad-checked">
                                       <input type="radio" class="btn-check" name="sealInput" id="sealInput34" autocomplete="off" value="bad">
                                       <label for="sealInput34">Bad</label>
                                    </div>
                                    <div class="form-btnw-wrap replaced-checked">
                                       <input type="radio" class="btn-check" name="sealInput" id="sealInput35" autocomplete="off" value="replaced">
                                       <label for="sealInput35">Replaced</label>
                                    </div>
                                    <div class="form-btnw-wrap upgrade-checked">
                                       <input type="radio" class="btn-check" name="sealInput" id="sealInput36" autocomplete="off" value="Upgraded">
