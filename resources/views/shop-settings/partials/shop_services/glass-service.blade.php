                   ...
                   <span class="newerr" style="color:red;display:none">Please select services</span>
                     <div class="col-lg-6">
                        ...
                        <div class="ac_service_content mt-4">
                           ...
                           <div class="btn-group" role="group">
                              <div class="form-btnw-wrap good-checked">
                                 <input type="radio" value="Good" class="btn-check" name="driver_back_window_motor" id="btnradio12" autocomplete="off">
                                 <label for="btnradio12">Good</label>
                              </div>
                              <div class="form-btnw-wrap bad-checked">
                                 <input type="radio" value="Bad" class="btn-check" name="driver_back_window_motor" id="btnradio13">
                                 <label for="btnradio13">Bad</label>
                              </div>
                              <div class="form-btnw-wrap replaced-checked">
                                 <input type="radio" value="Replaced" class="btn-check" name="driver_back_window_motor" id="btnradio14" autocomplete="off">
                        ...
                        <div class="ac_service_content mt-4">
                           ...
                           <div class="btn-group" role="group">
                              <div class="form-btnw-wrap good-checked">
                                 <input type="radio" value="Good" class="btn-check" name="passenger_front_window_motor" id="btnradio15" autocomplete="off">
                                 <label for="btnradio15">Good</label>
                              </div>
                              <div class="form-btnw-wrap bad-checked">
                                 <input type="radio" value="Bad" class="btn-check" name="passenger_front_window_motor" id="btnradio16"  autocomplete="off">
                                 <label for="btnradio16">Bad</label>
                              </div>
                              <div class="form-btnw-wrap replaced-checked">
                                 <input type="radio" value="Replaced" class="btn-check" name="passenger_front_window_motor" id="btnradio17" autocomplete="off">
                        ...
                        <div class="ac_service_content mt-4">
                           ...
                           <div class="btn-group" role="group">
                              <div class="form-btnw-wrap good-checked">
                                 <input type="radio" value="Good" class="btn-check" name="passenger_rear_window_motor" id="btnradio18" autocomplete="off">
                                 <label for="btnradio18">Good</label>
                              </div>
                              <div class="form-btnw-wrap bad-checked">
                                 <input type="radio" value="Bad" class="btn-check" name="passenger_rear_window_motor" id="btnradio19" autocomplete="off">
                                 <label for="btnradio19">Bad</label>
                              </div>
                              <div class="form-btnw-wrap replaced-checked">
                                 <input type="radio" value="Replaced" class="btn-check" name="passenger_rear_window_motor" id="btnradio20" autocomplete="off">
                        ...
                        <div class="ac_service_content mt-4">
                           ...
                           <div class="btn-group" role="group">
                              <div class="form-btnw-wrap good-checked">
                                 <input type="radio" value="Good" class="btn-check" name="back_hatch_window_motor" id="btnradio21" autocomplete="off">
                                 <label for="btnradio21">Good</label>
                              </div>
                              <div class="form-btnw-wrap bad-checked">
                                 <input type="radio" value="Bad" class="btn-check" name="back_hatch_window_motor" id="btnradio22" autocomplete="off">
                                 <label for="btnradio22">Bad</label>
                              </div>
                              <div class="form-btnw-wrap replaced-checked">
                                 <input type="radio" value="Replaced" class="btn-check" name="back_hatch_window_motor" id="btnradio23" autocomplete="off">
                                 <label for="btnradio23">Replaced</label>
                              </div>
                              <div class="form-btnw-wrap upgrade-checked">
                                 <input type="radio" value="NAH" class="btn-check" name="back_hatch_window_motor" id="btnradio24" autocomplete="off">
                     ...
                     <div class="col-lg-6">
                        <div class="btn-group" role="group" style="display: flex;
                           column-gap: 15px;">
                           <div class="form-btnw-wrap upgrade-checked">
                              <input type="radio" value="Front" class="btn-check" name="windshield_replaced" id="btnradio25" autocomplete="off">
                              <label for="btnradio25">WINDSHIELD REPLACED - FRONT</label>
                           </div>
                           <div class="form-btnw-wrap upgrade-checked">
                              <input type="radio" value="Rear" class="btn-check" name="windshield_replaced" id="btnradio26" autocomplete="off">
