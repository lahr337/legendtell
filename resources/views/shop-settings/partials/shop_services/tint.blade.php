                           ...
                           <div class="form-box">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-8 col-12 tint_types myerr">
                                       <div class="btn-group d-flex flex-row cmn-radio flex-wrap" role="group" style="column-gap: 10px; row-gap: 10px;">
                                          <div class="form-btnw-wrap">
                                             <input type="radio" value="HYBRID" class="btn-check" name="tint_type" id="btnradio25" autocomplete="off">
                                             <label for="btnradio25">HYBRID</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="radio" value="CARBON" class="btn-check" name="tint_type" id="btnradio26" autocomplete="off">
                                             <label for="btnradio26">CARBON</label>
                                          </div>
                                          <div class="form-btnw-wrap upgrade-checked">
                                             <input type="radio" value="CERAMIC" class="btn-check" name="tint_type" id="btnradio27" autocomplete="off">
                                             <label for="btnradio27">CERAMIC</label>
                                          </div>
                                          <div class="form-btnw-wrap upgrade-checked">
                                             <input type="radio" value="METALIZED" class="btn-check" name="tint_type" id="btnradio28" autocomplete="off">
                              ...
                              <div class="form-group mb-3 align-items-center">
                                 <div class="row">
                                    ...
                                    <div class="col-lg-8 col-12">
                                       <input type="text" class="form-control border-0 oem_manufacturer myerr" value="" style="height:35px" name="oem_manufacture">
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="form-group mb-3 align-items-center">
                                 <div class="row">
                                    ...
                                    <div class="col-lg-8 col-12">
                                       <input type="text" class="form-control border-0 waranty_company myerr tintwarentycompany" value="" style="height:35px" name="warranty_company">
                                    </div>
                                 </div>
                              </div>
