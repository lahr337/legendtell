                        ...
                        <div class="col-12 col-md-3 mo-3">
                           <div class="repaired-panel">
                              ...
                              <div class="grid-1 mb-3 cmn-radio myerr" id="damage_type_err">
                                 <div class="form-btnw-wrap">
                                    <input type="radio" value="HAIL DAMAGE" class="btn-check uncheck" name="damage_type" id="hail-damage" autocomplete="off">
                                    <label for="hail-damage">HAIL DAMAGE</label>
                                 </div>
                                 <div class="form-btnw-wrap">
                                    <input type="radio" value="PRIOR POOR PDR" class="btn-check uncheck" name="damage_type" id="poor-pdr" autocomplete="off">
                                    <label for="poor-pdr">PRIOR POOR PDR</label>
                                 </div>
                                 <div class="form-btnw-wrap">
                                    <input type="radio" value="FACTORY PAINT DAMAGE" class="btn-check uncheck" name="damage_type" id="factory-paint-damage" autocomplete="off">
                                    <label for="factory-paint-damage">FACTORY PAINT DAMAGE</label>
                                 </div>
                                 <div class="form-btnw-wrap">
                                    <input type="radio" value="PRIOR PAINT DAMAGE" class="btn-check uncheck" name="damage_type" id="prior-paint-damage" autocomplete="off">
