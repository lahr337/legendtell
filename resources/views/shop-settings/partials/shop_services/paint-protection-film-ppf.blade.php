                                 ...
                                 <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-md-6 col-12">
                                       <div class="btn-group d-flex flex-row cmn-radio myerr film_thickness_err" role="group" style="column-gap: 10px;">
                                          <div class="form-btnw-wrap">
                                             <input type="radio" class="btn-check film_thickness" value="8 MIL" name="film_thickness" id="btnradio1" autocomplete="off">
                                             <label for="btnradio1">8 MIL</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="radio" class="btn-check film_thickness" value="10 MIL" name="film_thickness" id="btnradio2" autocomplete="off">
