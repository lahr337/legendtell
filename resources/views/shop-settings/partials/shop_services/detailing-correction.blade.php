                                    ...
                                    <div class="correc-detail cmn-checked grid-2">
                                       <div class="btn-group" role="group">
                                          <div class="form-btnw-wrap">
                                             <input type="checkbox" class="btn-check" value="HANDWASH WATERLESS" name="correction[]" id="checkbox1" autocomplete="off">
                                             <label for="checkbox1">HANDWASH WATERLESS</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="checkbox" class="btn-check" value="CLAY PROCESS" name="correction[]" id="checkbox2" autocomplete="off">
                                             <label for="checkbox2">CLAY PROCESS</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="checkbox" class="btn-check" value="DECONTAMINATED ORGANIC" name="correction[]" id="checkbox3" autocomplete="off">
                                             <label for="checkbox3">DECONTAMINATED ORGANIC</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="checkbox" class="btn-check" value="DECONTAMINATED ORGANIC" name="correction[]" id="checkbox4" autocomplete="off">
                                             <label for="checkbox4">DECONTAMINATED INDUSTRIAL</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="checkbox" class="btn-check" value="DECONTAMINATED PETROLEUM" name="correction[]" id="checkbox5" autocomplete="off">
                                             <label for="checkbox5">DECONTAMINATED PETROLEUM</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="checkbox" class="btn-check" value="IRON DEPOSIT REMOVAL" name="correction[]" id="checkbox6" autocomplete="off">
                                             <label for="checkbox6">IRON DEPOSIT REMOVAL</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="checkbox" class="btn-check" value="HAND WET-SAND" name="correction[]" id="checkbox7" autocomplete="off">
                                             <label for="checkbox7">HAND WET-SAND</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="checkbox" class="btn-check" value="COMPOUND HEAVY CUT" name="correction[]" id="checkbox8" autocomplete="off">
                                             <label for="checkbox8">COMPOUND HEAVY CUT</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="checkbox" class="btn-check" value="COMPOUND MEDIUM CUT" name="correction[]" id="checkbox9" autocomplete="off">
                                             <label for="checkbox9">COMPOUND MEDIUM CUT</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="checkbox" class="btn-check" value="MEDIUM POLISH" name="correction[]" id="checkbox10" autocomplete="off">
                                             <label for="checkbox10">MEDIUM POLISH</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="checkbox" class="btn-check" value="FINISHING POLISH" name="correction[]" id="checkbox11" autocomplete="off">
                                             <label for="checkbox11">FINISHING POLISH</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="checkbox" class="btn-check" value="LIQUID/PASTE/CARNUBA WAX" name="correction[]" id="checkbox12" autocomplete="off">
                                             <label for="checkbox12">LIQUID/PASTE/CARNUBA WAX</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="checkbox" class="btn-check" value="SPRAY SEALANT" name="correction[]" id="checkbox13" autocomplete="off">
                                             <label for="checkbox13">SPRAY SEALANT</label>
                                          </div>
                                          <div class="form-btnw-wrap">
                                             <input type="checkbox" class="btn-check" value="CERAMIC COAT" name="correction[]" id="checkbox14" autocomplete="off">
                                    ...
                                    <div class="row d-flex">
                                       ...
                                       <div class="col-md-6 col-12">
                                          <div class="btn-group annual-year-detailing cmn-radio" role="group" style="column-gap: 10px;">
                                             <div class="form-btnw-wrap">
                                                <input type="radio" class="btn-check" value="YEAR 1" name="annual_completed" id="btnradio7" autocomplete="off">
                     ...
                     <div class="tab-pane fade" id="cleaning" role="tabpanel" aria-labelledby="cleaning-tab">
                        <form id="cleaningData">
                           ...
                           <div class="correc-detail cmn-checked grid-2 cmn-mx-75">
                              <div class="btn-group" role="group">
                                 <div class="form-btnw-wrap">
                                    <input type="checkbox" class="btn-check" value="HANDWASH" name="cleaning[]" id="checkbox15" autocomplete="off">
                                    <label for="checkbox15">HANDWASH</label>
                                 </div>
                                 <div class="form-btnw-wrap">
                                    <input type="checkbox" class="btn-check" value="WATERLESS WASH" name="cleaning[]" id="checkbox16" autocomplete="off">
                                    <label for="checkbox16">WATERLESS WASH</label>
                                 </div>
                                 <div class="form-btnw-wrap">
                                    <input type="checkbox" class="btn-check" value="CLAY" name="cleaning[]" id="checkbox17" autocomplete="off">
                                    <label for="checkbox17">CLAY</label>
                                 </div>
                                 <div class="form-btnw-wrap">
                                    <input type="checkbox" class="btn-check" value="LIGHT POLISH" name="cleaning[]" id="checkbox18" autocomplete="off">
                                    <label for="checkbox18">LIGHT POLISH</label>
                                 </div>
                                 <div class="form-btnw-wrap">
                                    <input type="checkbox" class="btn-check" value="RIM/TIRE CLEAN" name="cleaning[]" id="checkbox19" autocomplete="off">
                                    <label for="checkbox19">RIM/TIRE CLEAN</label>
                                 </div>
                                 <div class="form-btnw-wrap">
                                    <input type="checkbox" class="btn-check" value="WAX / SEALANT" name="cleaning[]" id="checkbox20" autocomplete="off">
                                    <label for="checkbox20">WAX / SEALANT</label>
                                 </div>
                                 <div class="form-btnw-wrap">
                                    <input type="checkbox" class="btn-check" value="TIRE DRESS" name="cleaning[]" id="checkbox21" autocomplete="off">
                                    <label for="checkbox21">TIRE DRESS</label>
                                 </div>
                                 <div class="form-btnw-wrap">
                                    <input type="checkbox" class="btn-check" value="WINDOW COATING" name="cleaning[]" id="checkbox22" autocomplete="off">
                                    <label for="checkbox22">WINDOW COATING</label>
                                 </div>
                                 <div class="form-btnw-wrap">
                                    <input type="checkbox" class="btn-check" value="QUICK DETAIL SPRAY" name="cleaning[]" id="checkbox23" autocomplete="off">
                                    <label for="checkbox23">QUICK DETAIL SPRAY</label>
                                 </div>
                                 <div class="form-btnw-wrap">
                                    <input type="checkbox" class="btn-check" value="SPRAY SEALANT" name="cleaning[]" id="checkbox24" autocomplete="off">
