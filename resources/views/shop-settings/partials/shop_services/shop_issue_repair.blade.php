                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control txt_issueBtn issuetabclose mynewcsl" name="repair_info" rows="5" id="text_regular_service" readonly></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control txt_issueBtn test issuetabclose mynewcsl" name="know_issue" rows="5" id="text_known_issue" readonly></textarea>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label>Manufacturer Recall Information:</label>
                                        <textarea class="form-control txt_issueBtn issuetabclose mynewcsl" name="recall_issue" rows="5" id="text_new_install" readonly></textarea>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label>Important New Install Information:</label>
                                        <textarea class="form-control txt_issueBtn issuetabclose mynewcsl" name="install_info" rows="5" id="text_manfacture_recall" readonly></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control txt_issueBtn issuetabclose mynewcsl" name="diagnosis" rows="5" id="text_general_repair" readonly></textarea>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label>Important Servicing Information:</label>
                                        <textarea class="form-control txt_issueBtn issuetabclose mynewcsl" rows="5" name="service_info" id="text_new_issue" readonly></textarea>
                                    </div>
                                </div>
