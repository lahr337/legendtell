<form class="account-settings__content account-settings__content-form {{ $tab == 'editProfile' ? 'account-settings__content--active' : '' }} settings-form"
    id="editProfile" action="{{route('shop-settings.save-profile')}}" method="PUT" accept-charset="multipart/form-data">
    @csrf
    @method('put')
        ...
        <div class="settings-form__fields col-12 col-md-8">
            ...
            ">
                ...
                <div class="fv-plugins-message-container">
                    <div id="shop_nameerror"class="fv-help-block" style="display:none">Shop Name is required</div></div>
            </div>
            ...
            ">
                ...
                <div class="custom-input__field-wr fv-row">
                    <input class="custom-input__field" id="number" name="contact_number" type="text" placeholder="661-654-5234" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" maxlength="12"
...
.custom-input--password input[type=text]~button .visible-eye, .custom-input--password input[type=password]~button .hidden-eye {
    display: block;
}
.custom-input--password input[type=password]~button .visible-eye, .custom-input--password input[type=text]~button .hidden-eye {
    display: none;
}
            </style>
