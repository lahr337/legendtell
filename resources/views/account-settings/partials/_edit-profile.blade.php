...
<form class="account-settings__content account-settings__content-form {{ $tab == 'editProfile' ? 'account-settings__content--active' : '' }} settings-form"
    id="editProfile" action="{{route('account-settings.save-profile')}}" method="PUT" accept-charset="multipart/form-data">
    @csrf
    @method('put')
                    ...
                    <div class="custom-input__field-wr">
                        ...
                        <button class="custom-input__eye-btn" id="showPassword" type="button">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg"><path d="M9.82828 7.25391C8.38687 7.25391 7.21109 8.48437 7.21109 9.99999C7.21109 11.5117 8.38297 12.7461 9.82828 12.7461C11.2697 12.7461 12.4455 11.5156 12.4455 9.99999C12.4455 8.48828 11.2697 7.25391 9.82828 7.25391V7.25391Z" fill="#BBBBBB" />
