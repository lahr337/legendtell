      ...
      <div class="container">
        <section class="add-car page">
          <div class="page-heading add-car__heading">
            ...
            <button
              class="add-car__add-heading-btn btn btn--accent"
              id="openAddCarModal"
              type="button"
            >
              Add car
            ...
            <div class="add-car__cars">
                ...
                @else
                    <div class="add-car__not-car-yeat not-car-yeat">
                        ...
                        >
                            <path
                            d="M17.0204 10.2109C17.4413 9.81863 17.4645 9.1595 17.0722 8.73866C16.68 8.3178 16.0208 8.29461 15.6 8.68685L12.552 11.5277L9.71111 8.47967C9.31886 8.05882 8.65972 8.03564 8.23888 8.42787C7.81802 8.82011 7.79484 9.47925 8.18707 9.9001L11.0279 12.9481L7.97989 15.7891C7.55904 16.1812 7.53586 16.8404 7.9281 17.2612C8.32034 17.6821 8.97947 17.7053 9.40033 17.313L12.4483 14.4722L15.2893 17.5202C15.6815 17.941 16.3406 17.9643 16.7615 17.572C17.1823 17.1798 17.2055 16.5206 16.8132 16.0998L13.9724 13.0518L17.0204 10.2109Z"
                            fill="#272727"
                            />
                            <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                            d="M1.04102 13C1.04102 6.67174 6.17109 1.54166 12.4993 1.54166C18.8276 1.54166 23.9577 6.67174 23.9577 13C23.9577 19.3282 18.8276 24.4583 12.4993 24.4583C6.17109 24.4583 1.04102 19.3282 1.04102 13ZM12.4993 22.375C7.32168 22.375 3.12435 18.1777 3.12435 13C3.12435 7.82233 7.32168 3.625 12.4993 3.625C17.6771 3.625 21.8743 7.82233 21.8743 13C21.8743 18.1777 17.6771 22.375 12.4993 22.375Z"
                            fill="#272727"
                            />
                        </svg>
                        </div>
                        <span class="not-car-yeat__text"
                        >You haven't added a car yet</span
                        >
                    </div>
                @endif
            </div>
