             ...
             <div class="row">
                ...
                <div class="col-12 col-md-6">
                   <ul class="desc-wrap">
                      ...
                      <li class="cmn-serve-title">{{ $car->miles ?? '1114'}} Miles</li>
                   </ul>
                </div>
             </div>
             <div class="row mt-5">
          ...
          //  print_r($arr);
             ...
             <div class="col-12 col-md-6 col-lg-4">
                <div class="services-wrap">
                   ...
                   @if($value==$last_key)
                   <a href="/car/viewservices/{{base64_encode($car->id.'%%%'.$value.'%%%'.$chkarrlength.'%%%'.$MyCar)}}" class="service-btn new-service-btn">New Service </a>
                   @else
                   <a href="/car/viewservices/{{base64_encode($car->id.'%%%'.$value.'%%%'.$chkarrlength.'%%%'.$MyCar)}}" class="service-btn">View Service </a>
