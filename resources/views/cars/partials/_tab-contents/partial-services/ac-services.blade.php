<div class="account-settings__content account-settings__content-payment servicenew ac-service account-settings__content--active  settings-form w-100" id="ac-service">
   <div class="account-settings__payment-methods payment-methods w-100">
      <style>
         .dashboard-asside-tab__item--active .dashboard-asside-tab__name {
            ...
            <div class="row">
               ...
               <div class="col-12 col-md-6">
                  <ul class="desc-wrap">
                     ...
                     <li class="cmn-serve-title">{{ $car->color ?? ''}}</li>
                     <li class="cmn-serve-title">{{ $car->milage ?? ''}} milage</li>
                  </ul>
               </div>
            </div>
            <div class="row mt-5">
         ...
         <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4">
               <div class="services-wrap">
                  ...
                  <a href="/car/viewservices/{{base64_encode($car->id.'%%%'.$carService->service_id.'%%%'.$chkarrlength.'%%%'.$MyCar.'%%%'.$ids)}}" class="service-btn new-service-btn">New Service</a>
                  @else
                  <a href="/car/viewservices/{{base64_encode($car->id.'%%%'.$carService->service_id.'%%%'.$chkarrlength.'%%%'.$MyCar.'%%%'.$ids)}}" class="service-btn">View Service </a>
                  @endif
                  <?php $chkarrlength++; ?>
                  @else
   ...
   <script>
      ...
      var add_css = ulWidth;
      $('head').append('<style>#sliderWrapper:after{width:' + add_css + ' !important;}</style>');
   </script>
