      ...
      <section class="dashboard-media">
        <div class="section-heading section-heading--justify-between">
          ...
          <div class="dashboard-media__heading-btns" id="Sticker--delBtnWr">
            <button class="dashboard-media__edit-btn btn btn--accent" id="Sticker--deleteMedia" type="button">
              Delete</button><button class="dashboard-media__edit-btn btn btn--accent-border" id="Sticker--cancelMedia"
              type="button">
              Cancel
            </button>
          </div>
        ...
        <div class="dashboard-media__items-wr" id="Sticker--gallery">
          ...
          @foreach($car->stickers as $sticker)
            @include('cars.partials._tab-contents._window-sticker._items', ['sticker' => $sticker])
          @endforeach
        </div>
        <div class="dashboard-media__items-wr">
          <div class="dashboard-media__item empty-media-item">
              ...
              <span class="empty-media-item__text">Add window sticker</span
              ><input class="empty-media-item__photo-loader" id="Sticker--photoLoader" type="file" multiple />
            </div>
        </div>
      </section>
    </div>