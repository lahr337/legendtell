        ...
        <section class="add-car page">
             ...
             <div class="content-cmn-wrap">
                <div class="row">
                   <div class="col-12 col-md-6">
                     ...
                     <img class ="w-100 carviewimg" src="{{$testdata[0]}}">
                     @endif
                    
                     @else
                     <img class ="w-100 carviewimg" src="{{ asset('/assets/images/image-empty-state.jpg') }}">
                     @endif
                   </div>
                   <div class="col-12 col-md-6">
                      <ul class="desc-wrap">
            ...
            @if($CarData->acHistory)
               ...
               <div class="row border-bb">
                  ...
                  <div class="col-6 col-md-6">
                     <div class="services-details">
                        <p class="primary-@if($CarData->acHistory->compressor=='good')green @elseif($CarData->acHistory->compressor=='bad')red  @elseif($CarData->acHistory->compressor=='replaced')yellow @else blue @endif">@if($CarData->acHistory->compressor=='good')Checks @elseif($CarData->acHistory->compressor=='bad')  @elseif($CarData->acHistory->compressor=='replaced')Was @else Was @endif  {{ucwords($CarData->acHistory->compressor)}}</p>
                     </div>
                  </div>
                  <div class="col-6 col-md-6">
                     <div class="services-details text-right">
                  ...
                  <div class="col-6 col-md-6">
                     <div class="services-details">
                        <p class="primary-@if($CarData->acHistory->evaporator_core=='good')green @elseif($CarData->acHistory->evaporator_core=='bad')red  @elseif($CarData->acHistory->evaporator_core=='replaced')yellow @else blue @endif">@if($CarData->acHistory->evaporator_core=='good')Checks @elseif($CarData->acHistory->evaporator_core=='bad')  @elseif($CarData->acHistory->evaporator_core=='replaced')Was @else Was @endif {{ucwords($CarData->acHistory->evaporator_core)}}</p>
                  ...
                  <div class="col-6 col-md-6">
                     <div class="services-details">
                        <p class="primary-@if($CarData->acHistory->receiver_dryer=='good')green @elseif($CarData->acHistory->receiver_dryer=='bad')red  @elseif($CarData->acHistory->receiver_dryer=='replaced')yellow @else blue @endif">@if($CarData->acHistory->receiver_dryer=='good')Checks @elseif($CarData->acHistory->receiver_dryer=='bad')  @elseif($CarData->acHistory->receiver_dryer=='replaced')Was @else Was @endif {{ucwords($CarData->acHistory->receiver_dryer)}}</p>
                     </div>
                  </div>
                  <div class="col-6 col-md-6">
                     <div class="services-details text-right">
                  ...
                  <div class="col-6 col-md-6">
                     <div class="services-details">
                        ...
                        <p class="primary-@if($CarData->acHistory->ac_line=='good')green @elseif($CarData->acHistory->ac_line=='bad')red  @elseif($CarData->acHistory->ac_line=='replaced')yellow @else blue @endif">@if($CarData->acHistory->ac_line=='good')Checks @elseif($CarData->acHistory->ac_line=='bad')  @elseif($CarData->acHistory->ac_line=='replaced')Was @else Was @endif {{ucwords($CarData->acHistory->ac_line)}}</p>
                     </div>
                  </div>
                  <div class="col-6 col-md-6">
                     <div class="services-details text-right">
                  ...
                  <div class="col-6 col-md-6">
                     <div class="services-details">
                        <p class="primary-@if($CarData->acHistory->pressure_switches=='good')green @elseif($CarData->acHistory->pressure_switches=='bad')red  @elseif($CarData->acHistory->pressure_switches=='replaced')yellow @else blue @endif">@if($CarData->acHistory->pressure_switches=='good')Checks @elseif($CarData->acHistory->pressure_switches=='bad')  @elseif($CarData->acHistory->pressure_switches=='replaced')Was @else Was @endif {{ucwords($CarData->acHistory->pressure_switches)}}</p>
                     </div>
                  </div>
                  <div class="col-6 col-md-6">
                     <div class="services-details text-right">
                  ...
                  <div class="col-6 col-md-6">
                     <div class="services-details">
                        <p class="primary-@if($CarData->acHistory->office_tube=='good')green @elseif($CarData->acHistory->office_tube=='bad')red  @elseif($CarData->acHistory->office_tube=='replaced')yellow @else blue @endif">@if($CarData->acHistory->office_tube=='good')Checks @elseif($CarData->acHistory->office_tube=='bad')  @elseif($CarData->acHistory->office_tube=='replaced')Was @else Was @endif {{ucwords($CarData->acHistory->office_tube)}}</p>
                     </div>
                  </div>
                  <div class="col-6 col-md-6">
                     <div class="services-details text-right">
                  ...
                  <div class="col-6 col-md-6">
                     <div class="services-details">
                        <p class="primary-@if($CarData->acHistory->expansion_valve=='good')green @elseif($CarData->acHistory->expansion_valve=='bad')red  @elseif($CarData->acHistory->expansion_valve=='replaced')yellow @else blue @endif">@if($CarData->acHistory->expansion_valve=='good')Checks @elseif($CarData->acHistory->expansion_valve=='bad')  @elseif($CarData->acHistory->expansion_valve=='replaced')Was @else Was @endif {{ucwords($CarData->acHistory->expansion_valve)}}</p>
                     </div>
                  </div>
                  <div class="col-6 col-md-6">
                     <div class="services-details text-right">
            ...
            {{-- end ac service --}}
             ...
             @if($serviceId==2)
                @if($CarData->breakHistory)
                    ...
                    <div class="col-6 col-md-6">
                        <div class="services-details">
                            <p class="primary-@if($CarData->breakHistory->driver_front_break=='Good')green @elseif($CarData->breakHistory->driver_front_break=='Bad')red  @elseif($CarData->breakHistory->driver_front_break=='Replaced')yellow @else blue @endif">@if($CarData->breakHistory->driver_front_break=='Good')Checks @elseif($CarData->breakHistory->driver_front_break=='Bad')  @elseif($CarData->breakHistory->driver_front_break=='Replaced')Was @else Was @endif{{ucwords($CarData->breakHistory->driver_front_break)}}</p>
                        </div>
                    </div>
                    <div class="col-6 col-md-6">
                        <div class="services-details text-right">
                    ...
                    <div class="col-6 col-md-6">
                        <div class="services-details">
                            <p class="primary-@if($CarData->breakHistory->driver_rear_rotors=='Good')green @elseif($CarData->breakHistory->driver_rear_rotors=='Bad')red  @elseif($CarData->breakHistory->driver_rear_rotors=='Replaced')yellow @else blue @endif">@if($CarData->breakHistory->driver_rear_rotors=='good')Checks @elseif($CarData->breakHistory->driver_rear_rotors=='Bad')  @elseif($CarData->breakHistory->driver_rear_rotors=='Replaced')Was @else Was @endif{{ucwords($CarData->breakHistory->driver_rear_rotors)}}</p>
                        </div>
                    </div>
                    <div class="col-6 col-md-6">
                        <div class="services-details text-right">
                    ...
                    <div class="col-6 col-md-6">
                        <div class="services-details">
                            ...
                            <p class="primary-@if($CarData->breakHistory->passenger_front_brakes=='Good')green @elseif($CarData->breakHistory->passenger_front_brakes=='Bad')red  @elseif($CarData->breakHistory->passenger_front_brakes=='Replaced')yellow @else blue @endif">@if($CarData->breakHistory->passenger_front_brakes=='Good')Checks @elseif($CarData->breakHistory->passenger_front_brakes=='Bad')  @elseif($CarData->breakHistory->passenger_front_brakes=='Replaced')Was @else Was @endif{{ucwords($CarData->breakHistory->passenger_front_brakes)}}</p>
                        </div>
                    </div>
                    <div class="col-6 col-md-6">
                        <div class="services-details text-right">
                    ...
                    <div class="col-6 col-md-6">
                        <div class="services-details">
                            <p class="primary-@if($CarData->breakHistory->passenger_front_rotors=='Good')green @elseif($CarData->breakHistory->passenger_front_rotors=='Bad')red  @elseif($CarData->breakHistory->passenger_front_rotors=='Replaced')yellow @else blue @endif">@if($CarData->breakHistory->passenger_front_rotors=='Good')Checks @elseif($CarData->breakHistory->passenger_front_rotors=='Bad')  @elseif($CarData->breakHistory->passenger_front_rotors=='Replaced')Was @else Was @endif{{ucwords($CarData->breakHistory->passenger_front_rotors)}}</p>
                        </div>
                    </div>
                    <div class="col-6 col-md-6">
                        <div class="services-details text-right">
                    ...
                    <div class="col-6 col-md-6">
                        <div class="services-details">
                            <p class="primary-@if($CarData->breakHistory->driver_front_calipers=='Good')green @elseif($CarData->breakHistory->driver_front_calipers=='Bad')red  @elseif($CarData->breakHistory->driver_front_calipers=='Replaced')yellow @else blue @endif">@if($CarData->breakHistory->driver_front_calipers=='Good')Checks @elseif($CarData->breakHistory->driver_front_calipers=='Bad')  @elseif($CarData->breakHistory->driver_front_calipers=='Replaced')Was @else Was @endif{{ucwords($CarData->breakHistory->driver_front_calipers)}}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-6">
                        <div class="services-details">
                            <p class="primary-@if($CarData->breakHistory->driver_rear_calipers=='Good')green @elseif($CarData->breakHistory->driver_rear_calipers=='Bad')red  @elseif($CarData->breakHistory->driver_rear_calipers=='Replaced')yellow @else blue @endif">@if($CarData->breakHistory->driver_rear_calipers=='Good')Checks @elseif($CarData->breakHistory->driver_rear_calipers=='Bad')  @elseif($CarData->breakHistory->driver_rear_calipers=='Replaced')Was @else Was @endif{{ucwords($CarData->breakHistory->driver_rear_calipers)}}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-6">
                        <div class="services-details">
                            <p class="primary-@if($CarData->breakHistory->brake_hoses=='Good')green @elseif($CarData->breakHistory->brake_hoses=='Bad')red  @elseif($CarData->breakHistory->brake_hoses=='Replaced')yellow @else blue @endif">@if($CarData->breakHistory->brake_hoses=='Good')Checks @elseif($CarData->breakHistory->brake_hoses=='Bad')  @elseif($CarData->breakHistory->brake_hoses=='Replaced')Was @else Was @endif{{ucwords($CarData->breakHistory->brake_hoses)}}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-6">
                        <div class="services-details">
                            <p class="primary-@if($CarData->breakHistory->brake_lines=='Good')green @elseif($CarData->breakHistory->brake_lines=='Bad')red  @elseif($CarData->breakHistory->brake_lines=='Replaced')yellow @else blue @endif">@if($CarData->breakHistory->brake_lines=='Good')Checks @elseif($CarData->breakHistory->brake_lines=='Bad')  @elseif($CarData->breakHistory->brake_lines=='Replaced')Was @else Was @endif{{ucwords($CarData->breakHistory->brake_lines)}}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-6">
                        <div class="services-details">
                            <p class="primary-@if($CarData->breakHistory->wheel_cylinder=='Good')green @elseif($CarData->breakHistory->wheel_cylinder=='Bad')red  @elseif($CarData->breakHistory->wheel_cylinder=='Replaced')yellow @else blue @endif">@if($CarData->breakHistory->wheel_cylinder=='Good')Checks @elseif($CarData->breakHistory->wheel_cylinder=='Bad')  @elseif($CarData->breakHistory->wheel_cylinder=='Replaced')Was @else Was @endif{{ucwords($CarData->breakHistory->wheel_cylinder)}}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-6">
                        <div class="services-details">
                            <p class="primary-@if($CarData->breakHistory->master_cylinder=='Good')green @elseif($CarData->breakHistory->master_cylinder=='Bad')red  @elseif($CarData->breakHistory->master_cylinder=='Replaced')yellow @else blue @endif">@if($CarData->breakHistory->master_cylinder=='Good')Checks @elseif($CarData->breakHistory->master_cylinder=='Bad')  @elseif($CarData->breakHistory->master_cylinder=='Replaced')Was @else Was @endif{{ucwords($CarData->breakHistory->master_cylinder)}}</p>
                        </div>
                    </div>
...
{{-- end engine spicality service --}}
   ...
   @if($CarData->exhaustService)
         <div class="row border-bb">
            ...
            <div class="col-6 col-md-6">
               <div class="services-details">
                  <p class="primary-@if($CarData->exhaustService->exhaust_manifold=='Good')green @elseif($CarData->exhaustService->exhaust_manifold=='Bad')red  @elseif($CarData->exhaustService->exhaust_manifold=='Replaced')yellow @else blue @endif">@if($CarData->exhaustService->exhaust_manifold=='Good')Checks @elseif($CarData->exhaustService->exhaust_manifold=='Bad')  @elseif($CarData->exhaustService->exhaust_manifold=='Replaced')Was @else Was @endif{{ucwords($CarData->exhaustService->exhaust_manifold)}}</p>
               </div>
            </div>
         ...
         <div class="col-6 col-md-6">
            <div class="services-details">
               <p class="primary-@if($CarData->exhaustService->exhaust_resonator=='Good')green @elseif($CarData->exhaustService->exhaust_resonator=='Bad')red  @elseif($CarData->exhaustService->exhaust_resonator=='Replaced')yellow @else blue @endif">@if($CarData->exhaustService->exhaust_resonator=='Good')Checks @elseif($CarData->exhaustService->exhaust_resonator=='Bad')  @elseif($CarData->exhaustService->exhaust_resonator=='Replaced')Was @else Was @endif{{ucwords($CarData->exhaustService->exhaust_resonator)}}</p>
            </div>
         </div>
         ...
         <div class="col-6 col-md-6">
            <div class="services-details">
               <p class="primary-@if($CarData->exhaustService->exhaust_muffler=='Good')green @elseif($CarData->exhaustService->exhaust_muffler=='Bad')red  @elseif($CarData->exhaustService->exhaust_muffler=='Replaced')yellow @else blue @endif">@if($CarData->exhaustService->exhaust_muffler=='Good')Checks @elseif($CarData->exhaustService->exhaust_muffler=='Bad')  @elseif($CarData->exhaustService->exhaust_muffler=='Replaced')Was @else Was @endif{{ucwords($CarData->exhaustService->exhaust_muffler)}}</p>
            </div>
         </div>
         ...
         <div class="col-6 col-md-6">
            <div class="services-details">
               <p class="primary-@if($CarData->exhaustService->exhaust_pipes=='Good')green @elseif($CarData->exhaustService->exhaust_pipes=='Bad')red  @elseif($CarData->exhaustService->exhaust_pipes=='Replaced')yellow @else blue @endif">@if($CarData->exhaustService->exhaust_pipes=='Good')Checks @elseif($CarData->exhaustService->exhaust_pipes=='Bad')  @elseif($CarData->exhaustService->exhaust_pipes=='Replaced')Was @else Was @endif{{ucwords($CarData->exhaustService->exhaust_pipes)}}</p>
            </div>
         </div>
         <div class="col-6 col-md-6">
            <div class="services-details text-right">
         ...
         <div class="col-6 col-md-6">
            <div class="services-details">
               <p class="primary-@if($CarData->exhaustService->exhaust_isolators=='Good')green @elseif($CarData->exhaustService->exhaust_isolators=='Bad')red  @elseif($CarData->exhaustService->exhaust_isolators=='Replaced')yellow @else blue @endif">@if($CarData->exhaustService->exhaust_isolators=='Good')Checks @elseif($CarData->exhaustService->exhaust_isolators=='Bad')  @elseif($CarData->exhaustService->exhaust_isolators=='Replaced')Was @else Was @endif{{ucwords($CarData->exhaustService->exhaust_isolators)}}</p>
            </div>
         </div>
         <div class="col-6 col-md-6">
            <div class="services-details text-right">
         ...
         <div class="col-6 col-md-6">
            <div class="services-details">
               <p class="primary-@if($CarData->exhaustService->exhaust_o2sensor=='Good')green @elseif($CarData->exhaustService->exhaust_o2sensor=='Bad')red  @elseif($CarData->exhaustService->exhaust_o2sensor=='Replaced')yellow @else blue @endif">@if($CarData->exhaustService->exhaust_isolators=='Good')Checks @elseif($CarData->exhaustService->exhaust_isolators=='Bad')  @elseif($CarData->exhaustService->exhaust_isolators=='Replaced')Was @else Was @endif{{ucwords($CarData->exhaustService->exhaust_o2sensor)}}</p>
            </div>
         </div>
